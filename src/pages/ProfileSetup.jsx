  ...
  return (
    <div className="min-h-screen bg-gradient-to-tr from-[#FFF0F5] via-[#F3E5F5] to-[#E8F5E9] flex flex-col justify-center items-center p-6 font-sans" dir="rtl">
      ...
      <div className="w-full max-w-md bg-white/85 backdrop-blur-md rounded-3xl p-8 shadow-[0_8px_30px_rgb(244,143,177,0.12)] border border-pink-100/50 flex flex-col">
        ...
        {/* الهيدر الترحيبي ثابت بدون مؤثرات حركية */}
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-pink-300 to-purple-400 rounded-full text-white text-3xl shadow-md mb-3">
            🌸
          </div>
        ...
        <form onSubmit={handleManualRegister} className="space-y-4">
          <div>
            ...
            <input
              ...
              disabled={loading}
              className="w-full px-5 py-3.5 bg-pink-50/20 border border-pink-100/60 rounded-2xl text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-pink-300 focus:bg-white text-right"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              disabled={loading}
              className="w-full px-5 py-3.5 bg-pink-50/20 border border-pink-100/60 rounded-2xl text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-pink-300 focus:bg-white text-left"
            />
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-4 bg-gradient-to-r from-pink-400 to-purple-400 text-white font-semibold rounded-2xl shadow-lg hover:from-pink-500 hover:to-purple-500 active:scale-[0.98] mt-6 flex items-center justify-center gap-2 disabled:opacity-50"
          >
        ...
        <button
          ...
          disabled={loading}
          className="w-full py-3.5 px-4 bg-[#1877F2] text-white font-medium rounded-2xl shadow-md hover:bg-[#166FE5] flex items-center justify-center gap-3 disabled:opacity-50"
        >

    ...
    <div style={styles.pageBackground}>
      <article style={styles.container}>
        ...
        <section style={styles.content}>
          ...
          <div style={styles.card}>
            <h3 style={styles.cardTitle}>3. النوم والترميم الهرموني</h3>
            <p>نقص النوم يرفع هرمون <strong>الكورتيزول</strong>، مما يؤدي لتراكم الدهون واضطراب المزاج. احرصي على 7-8 ساعات من النوم الجيد.</p>
          </div>
        </section>
          ...
          <table style={styles.table}>
            ...
            <tbody>
              ...
              <tr style={styles.tableRowAlt}>
                <td style={styles.td}>فحص الثدي الذاتي</td>
                <td style={styles.td}>شهرياً</td>
              </tr>
              <tr>
                <td style={styles.td}>قياس ضغط الدم والسكر</td>
                <td style={styles.td}>كل 6 أشهر (بعد سن الـ 30)</td>
              </tr>
            </tbody>
          </table>
        </section>
        ...
        <footer style={styles.footerQuote}>
          <p><blockquote>"تذكري أن الكوب الفارغ لا يمكنه سقي الآخرين. اهتمامك بصحتك ليس رفاهية، بل هو المحرك الأساسي للعطاء."</blockquote></p>
        </footer>
      </article>
    </div>
  );

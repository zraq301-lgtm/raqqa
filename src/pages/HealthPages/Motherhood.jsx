...
const App = () => {
  ...
  const handleMediaAction = async (type) => {
    try {
      ...
      // إرسال الصورة للذكاء الاصطناعي للتحليل
          ...
          <div style={styles.chatBox}>
            ...
            <div style={styles.chatInputArea}>
              <div style={styles.mediaBar}>
                <button onClick={() => handleMediaAction('camera')} style={styles.mediaIcon}><i className="fas fa-camera"></i></button>
                <button onClick={() => handleMediaAction('gallery')} style={styles.mediaIcon}><i className="fas fa-image"></i></button>
              </div>
...
const styles = {
  ...
  mediaIcon: { background: 'none', border: 'none', color: '#2e8b57', fontSize: '18px' },

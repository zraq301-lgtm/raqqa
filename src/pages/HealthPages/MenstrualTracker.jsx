...
await CapacitorHttp.post(saveOptions); [cite_start]// [cite: 8, 10]

      // 2. مرحلة التحليل عبر API الذكاء الاصطناعي
      const promptText = userInput 
        ?
`أنا أنثى مسلمة، أحتاج استشارة طبية بناءً على هذه البيانات: ${summary}.
سؤالي هو: ${userInput}`
...
response.data.message || "عذراً رقية، لم أتمكن من التحليل.";
      ...
      <div style={styles.card}>
        ...
        {notifications.length > 0 && (
          <div style={{ background: '#FFF3E0', padding: '10px', borderRadius: '10px', marginBottom: '10px', fontSize: '12px', color: '#E65100' }}>
           ...
           🔔 نصيحة طبية: {notifications[0].body}
          </div>
        )}
...
handleProcess(); }} style={styles.btnPrimary}>
        {loading ?
"جاري الحفظ والتحليل..." : "حفظ وتحليل الحالة طبياً"}
      </button>

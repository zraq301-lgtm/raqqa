  ...
  return (
    <div className="app-container" dir="rtl">
      <style>{`
        ...
        .analyze-full-btn { grid-column: span 2; background: #7C3AED; color: white; border: none; padding: 12px; border-radius: 12px; font-weight: bold; margin-top: 5px; cursor: pointer; }
